...
export function Dashboard(){
    ...
    const totalInterval = `01 a ${lastTransanctionExpensives}`
    ...
    setHighlightData({
        entries: {
            ...
            lastTransaction: `Última entrada dia ${lastTransanctionEntries}`
        },
        expensives: {
            ...
            lastTransaction: `Última saída dia ${lastTransanctionEntries}`
        },
        total: {
